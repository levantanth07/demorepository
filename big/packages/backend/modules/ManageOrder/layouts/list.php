...
<table border="1" cellspacing="0" cellpadding="5" bordercolor="#CCC">
  ...
  <tr>
    <td align="center">Tất cả <input  class="excel-opt" name="check_all" type="checkbox" value="1" id="check_all" title="Chọn tất cả" /></td>
  ...
  <tr bgcolor="#EFEFEF">
    ...
    <!--LIST:orders-->
     <tr>
        ...
        <td align="right"><?php echo System::display_number([[=orders.total=]]);?></td>
...
jQuery(document).ready(function(){
	jQuery('#check_all').click(function(){
		if(!($check = jQuery(this).is(':checked'))){
			$check = false;
		}else{
			$check = true;
		}
		jQuery('.excel-opt').prop('checked', $check);
