<?php
$title = 'Báo cáo tỷ lệ doanh thu ước chừng';
?>
<style type="text/css">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-dark">
            ...
            <li class="breadcrumb-item">
                <?=$title?> - <a href="https://big.shopal.vn/bai-viet/huong-dan-su-dung/bao-cao-ty-le-doanh-thu-uoc-chung/"
                                  target="_blank"
                                  class="btn btn-default" style="padding: 0px 2px;">
        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-inline" id="report">
                    ...
                    <h2 id="title-report" class="text-center">Báo cáo Chi phí Hệ thống <b id="system-name"></b></h2>
...
<script type="text/javascript">
    const MAX_SYSTEM_SELECTED = <?=CostForm::MAX_SYSTEM_SELECTED?>;
