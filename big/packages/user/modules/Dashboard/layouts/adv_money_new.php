            ...
            <form method="get" enctype="multipart/form-data" action="/index062019.php">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong style="line-height: 30px">Báo cáo chi phí quảng cáo theo khung giờ</strong>
                        <div class="pull-right">
                            ...
                            <a href="<?=Url::build('admin_group_info')?>#marketing" class="btn btn-default"> <i class="fa fa-exclamation-triangle"></i> Cài đặt cảnh báo và khung giờ</a>
                            <!--/IF:cond-->
                        </div>
                    </div>
                    ...
                    <div class="panel-body form-inline">
                        ...
                        <input name="do" type="hidden" value="adv_money_new">
                        <div class="nav">
                    ...
                    <div id="reportForm">
                        <h2 class="text-center">Báo cáo chi phí quảng cáo theo khung giờ</h2>
                        <p class="text-center">(Chú ý: báo cáo chỉ tính CPQC cao nhất trong ngày của marketing)</p>
                        ...
                        <?php elseif(Form::has_flash_message(AdvNewDashboardForm::FLASH_MESSAGE_KEY)):?>
                            <?=Form::draw_flash_message_error(AdvNewDashboardForm::FLASH_MESSAGE_KEY, ['margin' => '15px'])?>
                        <?php else:?>
                                        ...
                                        <?php foreach ($this->map['times'] as $key1 => $time): ?>
                                            ...
                                            <?php foreach ($this->map['rowname'] as $rownameIndex => $rname): ?>
                                                <tr class="time-block-<?=$time?>">
                                                    <!-- Render ngày -->
                                                    <?php if($i++ === 0): ?>
                                                        <td style="border:1px solid #999;" group="day" rowspan="<?=$this->map['rowspan_date']?>"><?=$key?></td>
                                                    <?php endif;?>
