<?php
class ViewReportDayForm extends Form
{
    protected $map;
    function __construct()
    {
        Form::Form('ViewReportDayForm');
    }
    function draw(){
        ...
        $reports = array();
        $get_revenue_status = DashboardDB::get_revenue_status_update();
        $arrStatus = [];
        foreach ($get_revenue_status as $k => $v) {
            $arrStatus[] = $v['id'];
        }
        ...
        $this->parse_layout('view_report_day',$this->map);
    }
}
?>