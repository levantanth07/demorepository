<?php
class AdvNewDashboardForm extends Form
{
    const FLASH_MESSAGE_KEY = 'adv_money_new_time';
    ...
    public function draw()
    {
        ...
        $this->parse_layout('adv_money_new',$this->map);
    }
    ...
    private function _getBudget()
    {
        ...
        if(!empty($sourceRequest)){
            ...
            $strSourceRequets = implode(',', $sourceFormat);
            if ($this->isObd) {
                $_strSourceRequets = DashboardDB::getIncludeSourceIds($strSourceRequets, $this->group_id);
            } else {
                $_strSourceRequets = $strSourceRequets;
            }//end if
        }
        $bundleRequest = [];
        $bundleRequest = Url::get('bundle_ids');
        ...
        if(!empty($bundleRequest)){
            ...
            if ($this->isObd) {
                ...
                $_strBundleRequets = $strBundleRequets;
            }//end if
        }
        $condSource = '';
        $condBundle = '';
