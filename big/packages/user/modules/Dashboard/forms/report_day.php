<?php
class ReportDayForm extends Form
{
    protected $map;
    function __construct()
    {
        Form::Form('ReportDayForm');
    ...
    function draw(){
        ...
        // insert into `roles_activities`(`code`,`name`,`position`) VALUES('BC_BXH_VINH_DANH','Xem báo cáo BXH Vinh Danh','4')
        if (DashboardDB::checkPermissionBXHReport() == false) {
                Url::js_redirect(false,'Bạn không có quyền truy cập!');
            }   
        $this->parse_layout('report_day');
    }
}
?>