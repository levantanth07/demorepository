<div class="frame-home-bound" style="margin-bottom: 10px;" <?php if(Module::get_setting('extra_css_bound')){ echo 'style="'.Module::get_setting('extra_css_bound').'"'; }?> >
    ...
    <div class="frame-home-content" style="background: #f4f4f4;">{{-content-}}</div>
</div>