<script>
	...
	{
		jQuery('#cmd').val(cmd);
		document.CrmCustomerPathology.submit();
	}
</script>
<?php System::set_page_title([[=title=]]); ?>
<fieldset id="toolbar">
    <div class="col-md-8">
        <h3 class="title"><i class="fa fa fa-medkit text-info"></i> [[|title|]]</h3>
    </div>
    <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-11">
                <form class="form-inline" style="padding: 15px 0 0 0;" action="/<?php echo Url::build_current(array('cmd'=>'search'));?>">
                    <input name="page" type="hidden" value="benh-ly" />
                ...
                <form name="CrmCustomerPathology" method="post" action="index062019.php?page=thuchi">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-hover table-striped" cellpadding="6" cellspacing="0" width="100%" style="#width:99%;margin-top:8px;" border="1" bordercolor="#E7E7E7" align="center">
                                    ...
                                    <tr valign="middle" bgcolor="#F0F0F0" style="line-height:20px">
                                        ...
                                        <th width="8%" align="left">Tên Bệnh</th>
                                        <th width="10%" align="left" class="text-center">Tên KH</th>
                                        <th width="8%" align="left" class="text-center">SĐT KH</th>
                                        <th width="10%" align="center" class="text-center">Tình trạng bệnh</th>
                                        <th width="10%" align="center" class="text-center">Người Tạo</th>
                                        <th width="5%" align="center" class="text-center">TG Tạo</th>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%" align="left"><a href="<?php echo Url::build('customer',[ 'cid' => [[=items.customer_id=]], 'do' => 'view' ] )?>"><strong class="text-danger">[[|items.customer_name|]]</strong></a></td>
                                        <td width="8%" align="left">[[|items.customer_mobile|]]</td>
                                        <td width="10%" align="left"><span class="small">[[|items.note|]]</span></td>
                                        <td width="10%" align="left">[[|items.created_user_name|]]</td>
                                        <td align="center">[[|items.created_time|]]</td>
                                        <?php if(Session::get('admin_group') || CrmCustomerPathologyDB::can_edit() ){?>
                                        <td align="left" width="2%">

                                            <?php if (Session::get('admin_group') || CrmCustomerPathologyDB::can_edit([[=items.created_user_id=]])) { ?>
            ...
            <div class="col-md-1">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <a class="btn-success btn btn-lg" href="<?php echo URL::build('lich-su-cuoc-goi', ['cid']);?>" title="Lịch sử bệnh lý">
