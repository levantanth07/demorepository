<script>
	...
	{
		jQuery('#cmd').val(cmd);
		document.CrmCustomerCallHistory.submit();
	}
</script>
<?php System::set_page_title([[=title=]]); ?>
<fieldset id="toolbar">
    <div class="col-md-8">
        <h3 class="title"><i class="fa fa-phone-square text-success"></i> [[|title|]]</h3>
    </div>
    <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-11">
                <form class="form-inline" style="padding: 15px 0 0 0;" action="/<?php echo Url::build_current(array('cmd'=>'search'));?>">
                    <input name="page" type="hidden" value="lich-su-cuoc-goi" />
                ...
                <form name="CrmCustomerCallHistory" method="post" action="index062019.php?page=thuchi">
                            ...
                            <div class="col-lg-12">
                                <table class="table table-hover table-striped" cellpadding="6" cellspacing="0" width="100%" style="#width:99%;margin-top:8px;" border="1" bordercolor="#E7E7E7" align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><?php echo $this->map['status_value'][[[=items.status=]]] ?></td>
