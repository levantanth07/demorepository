...
<div class="form_bound">
	<table cellpadding="0" width="100%"><tr><td  class="form_title"><?php echo $title;?></td><?php 
			if(URL::get('cmd')=='delete'){?><td class="form_title_button"><a href="javascript:void(0)" onclick="QlbhWarehouseForm.submit();"><img alt="" src="<?php echo Portal::template('core');?>/images/buttons/delete.jpg" style="text-align:center"/><br />[[.Delete.]]</a></td><?php
			}else{ 
...
<table cellspacing="0" width="100%">
  ...
  <td rowspan="5" align="center" valign="top">
	...
	<form name="QlbhWarehouseForm" method="post">
