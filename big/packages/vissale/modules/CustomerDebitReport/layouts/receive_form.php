        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <form name="EditCustomerDebitReport" id="EditCustomerDebitReport" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="bill_number" type="text" id="bill_number" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="category_id">Loại Thu</label>
                ...
                <div class="form-group">
                    ...
                    text-right" placeholder="00.00" onChange="this.value=numberFormat(this.value);">
                </div>
                <div class="form-group">
