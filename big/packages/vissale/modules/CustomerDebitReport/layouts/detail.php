    ...
    <div class="container">
        <div class="row">
            <form class="form-inline" style="padding: 15px 0 0 0;" action="/<?php echo Url::build_current(array('cmd'=>'search'));?>">
                ...
                <input name="cmd" type="hidden" value="detail" />
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <table class="" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    <td>Họ Tên:</td>
                                    <td><strong style="margin-left: 10px;">[[|name|]]</strong></td>
                                </tr>
                                <tr>
                                    <td>Số ĐT:</td>
                                    <td><strong style="margin-left: 10px;">[[|mobile|]]</strong></td>
                                </tr>
                                <tr>
                                    <td>Địa chỉ:</td>
                                    <td><strong style="margin-left: 10px;">[[|address|]]</strong></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <table class="table" cellpadding="6" cellspacing="0" width="100%" style="#width:99%;margin-top:8px;" border="1" bordercolor="#E7E7E7" align="center">
                                ...
                                <tr valign="middle" bgcolor="#F0F0F0" style="line-height:20px" class="text-center">
                                    ...
                                    <th width="10%" align="left" nowrap>Đơn Hàng</th>
                                ...
                                <tr>
                                    ...
                                    <td align="left" nowrap>
                                        <strong class="text-danger">[[|orders.code|]]</strong>
                                    </td>
                                    ...
                                    <td width="10%" align="right" nowrap class="amount text-danger">
                                        <strong>[[|orders.left_money|]]</strong>
                                    </td>
                                </tr>
