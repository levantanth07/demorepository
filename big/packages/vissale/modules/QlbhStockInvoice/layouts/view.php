<div class="container">
    ...
    <div class="panel">
        <div class="panel-header text-right">
            <input type="button" value="Danh sách phiếu" class="btn btn-default" onclick="window.location='<?php echo Url::build_current(array('type'))?>'">
            <button type="button" value="In" class="btn btn-default" onclick="ClickHereToPrint('ifrmPrint','invoiceWrapper');">
                    ...
                    <div style="padding:2px 2px 2px 2px;">
                        ...
                        <div style="text-align:left;">
                            <table width="100%" border="1" cellspacing="0" cellpadding="2" style="border-collapse:collapse" bordercolor="#CCC">
                                ...
                                <!--LIST:products-->
                                <tr>
                                    <td class="text-center">[[|products.i|]]</td>
                                    ...
                                    <td class="text-right">[[|products.payment_amount|]]</td>
                                    <!--/IF:cond-->
                                </tr>
                                <!--/LIST:products-->
                                ...
                                echo '<div style="display:none;page-break-after:always;">';
                                    ...
                                    <!--IF:cond([[=has_price=]] and Url::get('type')=='EXPORT')-->
                                    <td class="text-center">x</td>
                                    <td class="text-right text-bold">[[|total_amount|]]</td>
                                    <!--/IF:cond-->
                                </tr>
                            </table>
                        </div>
