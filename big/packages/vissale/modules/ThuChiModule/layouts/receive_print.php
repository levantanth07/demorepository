...
<div class="printBox">
    ...
    </div><div class="mb10" style="text-align:center;"><strong class="fs18"><span style="font-size:large;">PHIẾU THU</span></strong></div><div class="mb5" style="text-align:center;"><strong><span style="font-size:small;">M&atilde; phiếu thu: {Ma_Phieu}</span></strong></div><div class="mb25" style="text-align:center;"><em><span style="font-size:small;">Ng&agrave;y:&nbsp;</span></em><span style="color:#213140;font-size:small;line-height:22px;background-color:#ffffff;"><em>{Ngay_Thang_Nam}</em></span></div>
    <table width="100%">
        <tbody>
        <tr>
            <td colspan="2">
