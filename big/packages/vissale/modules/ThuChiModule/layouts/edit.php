    ...
    <fieldset id="toolbar">
        ...
        <div id="toolbar-content" align="right">
            <table align="right">
                <tbody>
                <tr>
                    <td id="toolbar-save"  align="center"><a onclick="EditThuChiModule.submit();"> <span title="Edit"> </span> Ghi lại </a> </td>
                    <td id="toolbar-back"  align="center"><a href="#" onchange="document.history(-1);return false;"> <span title="New"> </span> Quay lại </a> </td>
                </tr>
                </tbody>
            </table>
        </div>
