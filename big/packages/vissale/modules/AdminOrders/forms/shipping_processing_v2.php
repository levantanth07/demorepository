...
class ShippingProcessingFormV2 extends Form
{

    function __construct(){
        Form::Form('ShippingProcessingFormV2');
    }
...
//            $groups = AdminOrdersDB::getGroups();
        ...
        if (Url::get('search_text')) {
            ...
            $arrFilter['search_text'] = Url::get('search_text');
        }
...
//        echo 'step2-'.time().'<br>';
        ...
        $dataRes = EleFunc::cUrlPost(HOST_API . '/api/transport/list-order', $data_request);
...
//        echo 'step4-'.time().'<br>';
        ...
        $status_jobs_config = array(1 => 'Đang xử lý', 2 => 'Thành công', 16 => 'Thất bại');
...
//        echo 'step5-'.time().'<br>';
        $this->parse_layout('shipping_process_v2', [
            'groups' => $groups,
            'title' => $title,
