                ...
                <div class="box box-solid">
                    <div class="box-body">
                        ...
                        <form class="form-inline donhang-search-form" method="post" id="donhang-search-form" autocomplete="off">
                            ...
                            ?>
                            <div class="form-group">
                                <select name="shipping_option_id" id="shipping_option_id" class="form-control" style="width: 186px;" ></select>
                            </div>
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-search"></i> Tìm kiếm</button>
                            <a href="/index062019.php?page=admin_orders&cmd=shipping-processing"  class="btn btn-default" style="margin-bottom: 5px;">
                                <i class="fa fa-retweet"></i> Làm mới
                            </a>
                        </form>
                        <div class="text-right">
                            <label class="custom-control-label" style="float: left">
                                <a href="/index062019.php?page=admin_orders&cmd=shipping-processing-v3">
                                    Bấm đây để xem thêm các hãng Giao hàng nhanh, J&T, Best
                                </a>
                            </label>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped sticky-enabled tableheader-processed sticky-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/index062019.php?page=admin_orders&cmd=manager-shipping&search_text=<?= $shipping['lading_code'] ?>" target="_blank">
                                            <?= $shipping['lading_code'] ?>
                                        </a>
                                    </td>
                                    <td width="150">
                                            <span class="label <?= $status_jobs_config[$shipping['status_id']]['button'] ?>" style="width: 100%">
                                                <?= $status_jobs_config[$shipping['status_id']]['name'] ?>
                                            </span>
                                    </td>
                                    <td><?= $shipping['reasons'] ?></td>
                                    <td width="150"><?= date('d/m/Y H:i:s', $shipping['created_at']) ?></td>
                                </tr>
                                <?php
                                endforeach;
                                else:
...
<script>
    ...
    $(function() {
        ...
        setInterval(function () {
            window.location.href = window.location.origin + '/index062019.php?page=admin_orders&cmd=shipping-processing';
        }, 1000*60);
    })
</script>
